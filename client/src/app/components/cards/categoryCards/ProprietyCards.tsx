...
const ProprietyCards = ({ title, address = { street: '', number: '', city: '', state: '', zipCode: '' }, bedrooms, bathrooms, garage, condominium, price, badge }: WrapperCardsProps): React.JSX.Element => {
    ...
    return (
        <Link href={'#'} className="relative mx-auto w-full">
                ...
                <div className="shadow p-4 rounded-lg bg-white">
                    ...
                    <div className="mt-4">
                        <div className='flex justify-between'>
                            <span className='text-xl font-bold'>R$ {price},00</span>
                        </div>
                        <h2 className="font-medium text-base md:text-lg text-gray-800 line-clamp-1 pt-4" title="New York">
                            {title}
                        </h2>
                        <p className="mt-2 text-sm text-gray-500 line-clamp-1" title="New York, NY 10004, United States">
                            {formattedAddress}
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 mt-8">
                        ...
                        <div className="flex justify-end">
                            <p className="inline-flex flex-col lg:flex-row lg:items-center text-gray-800">
