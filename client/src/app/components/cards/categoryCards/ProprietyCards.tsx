...
const ProprietyCards = ({title, address = { street: '', number: '', city: '', state: '', zipCode: '' }, bedrooms, bathrooms, garage, condominium, price, badge}: WrapperCardsProps) => {
    const formattedAddress = `${address.street}, ${address.number}, ${address.city} - ${address.state}, ${address.zipCode}`;
