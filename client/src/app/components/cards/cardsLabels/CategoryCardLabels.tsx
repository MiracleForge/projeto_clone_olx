...
const SVGCLASS = {
    default: 'w-5 h-5 fill-current mr-2'
};

const IconLabel = ({ icon, value }: { icon: React.ReactNode, value: number }): React.JSX.Element => (
...
const iconMap: { [key: string]: React.ReactNode } = {
  bedrooms: (
    <svg className={`${SVGCLASS.default}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  garage: (
    <svg className={`${SVGCLASS.default}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 512">
...
const CategoryCardLabels = ({ bedrooms, bathrooms, garage }: LabelsIcons): React.JSX.Element => {
  const categories = [
...
export default CategoryCardLabels;
