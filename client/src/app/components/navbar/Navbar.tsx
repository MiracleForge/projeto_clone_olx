...
import logo_gato from '@/../../public/assets/images/logo-gatu.webp';
import { IoIosArrowDown } from "react-icons/io";
import { linksNavbar, productCategories } from '../../../../public/dynamicData/DynamicData';
...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white border-gray-200 dark:border-gray-600 dark:bg-black">
      ...
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-2">
        <div className='flex space-x-6'>
          ...
          <div className="flex items-center space-x-2 xl:ml-12">
            <div className="flex bg-gray-100 p-2 w-40 xl:w-72 xl:space-x-4 rounded-lg">
      
              <input className="bg-gray-100 outline-none text-sm w-36 xl:w-72" type="text" placeholder="" />
            </div>
